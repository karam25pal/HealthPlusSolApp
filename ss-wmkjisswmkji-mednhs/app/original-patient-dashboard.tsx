...
export default function MedicalAppHomepage() {
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                ...
                >
                  ...
                  <span className="font-medium text-sm">Mr. Singh</span>
              ...
              <DropdownMenuContent align="end" className="w-56 animate-in slide-in-from-top-2">
                <DropdownMenuLabel className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="font-medium">Mr. Singh</p>
                    <p className="text-xs text-gray-500">Patient ID: HP2024</p>
                  </div>
                </DropdownMenuLabel>
                <DropdownMenuSeparator />
                ...
                <DropdownMenuItem className="hover:bg-red-50 transition-colors cursor-pointer text-red-600">
      ...
      <div className="max-w-md mx-auto p-4 space-y-6 pb-20">
        ...
        <div className="flex items-center justify-between bg-white rounded-2xl p-4 shadow-sm hover:shadow-md transition-shadow duration-300">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-semibold text-gray-900">Good morning, Mr. Singh!</h1>
