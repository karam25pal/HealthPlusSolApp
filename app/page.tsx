...
function MedicalAppHomepage() {
  ...
  const [reportsOpen, setReportsOpen] = useState(false) // This will be managed by PatientNFTReports now
  ...
  const handleNavClick = (navId: string) => {
    ...
    if (navId === "messages") {
      ...
      // No longer opening a modal, PatientNFTReports is always rendered
      // You might want to scroll to the reports section or highlight it
  ...
  const patientName = "Mr. Singh" // Default patient name for the original UI
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-md mx-auto p-4 space-y-6 pb-20">
        ...
        {/* Symptoms Section - Now Slideable */}
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-md shadow-2xl">
        <CardHeader className="text-center">
          <div className="mx-auto w-16 h-16 bg-gradient-to-br from-black to-red-600 rounded-full flex items-center justify-center mb-4">
        ...
        <CardContent className="p-6 space-y-4">
          <Link href="/patient" target="_blank" passHref>
            <Button className="w-full h-16 text-lg bg-gray-900 hover:bg-black transition-all duration-300">
              <User className="mr-2 h-6 w-6" /> I am a Patient
            </Button>
          </Link>
          <Link href="/doctor" target="_blank" passHref>
            <Button className="w-full h-16 text-lg bg-red-600 hover:bg-red-700 transition-all duration-300">
              <Stethoscope className="mr-2 h-6 w-6" /> I am a Doctor
            </Button>
          </Link>
        </CardContent>
      </Card>
...
function App() {
  ...
  return <SolanaWalletProvider>{connected ? <MedicalAppHomepage /> : <RoleSelectionPage />}</SolanaWalletProvider>
}
